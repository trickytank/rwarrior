...
test_that("LEVEL_STATE class", {
  ...
  # feel()
  expect_equal(level_state_2_1$feel_symbol(level_state_2_1$warrior), " ")
  expect_equal(level_state_2_1$feel_symbol(level_state_2_1$warrior, "back"), "-")
  expect_false(level_state_2_1$feel_symbol(level_state_2_1$warrior, "back") != "-")
  expect_equal(level_state_test_2_1$feel_symbol(level_state_test_2_1$warrior, "f"), "s")
  expect_equal(level_state_test_2_1$feel_symbol(level_state_test_2_1$npcs[[1]], "f"), "@")
  # attack_routine()
