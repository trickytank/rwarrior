...
test_that("WARRIOR_ACTION", {
  ...
  expect_s3_class(WARRIOR_ACTION$new(game_state_9_1)$look("backward"))
  expect_s3_class(WARRIOR_ACTION$new(game_state_9_1)$look("right"))
  expect_s3_class(WARRIOR_ACTION$new(game_state_9_1)$look("left"))
})
